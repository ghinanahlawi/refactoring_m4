...
public class StatementPrinter {
    ...
    private static final int TRAGEDY_MIN_AUDIENCE = 30;
    ...
    public String statement() {
        ...
        result.append(String.format("Amount owed is %s%n", usd(rslt)));
        ...
        switch (getPlay(performance).getType()) {
            case "tragedy":
                ...
                if (performance.getAudience() > Constants.TRAGEDY_AUDIENCE_THRESHOLD) {
                    rslt += TRAGEDY_EXTRA_AMOUNT * (performance.getAudience() - TRAGEDY_MIN_AUDIENCE);
